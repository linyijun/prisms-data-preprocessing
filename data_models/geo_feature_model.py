...
class LosAngeles100mGridGeoFeature(GeoFeatureTemplate, Base):
    __tablename__ = 'los_angeles_100m_grid_geo_feature'
...
class SaltLakeCity100mGridGeoFeature(GeoFeatureTemplate, Base):
    __tablename__ = 'salt_lake_city_100m_grid_geo_feature'
...
class LosAngeles100mGridGeoVector(GeoVectorTemplate, Base):
    __tablename__ = 'los_angeles_100m_grid_geo_vector'
...
class SaltLakeCity100mGridGeoVector(GeoVectorTemplate, Base):
    __table_args__ = {'schema': 'preprocess2'}
    __tablename__ = 'salt_lake_city_100m_grid_geo_vector'
...
class LosAngeles100mGridGeoName(GeoNameTemplate, Base):
    __tablename__ = 'los_angeles_100m_grid_geo_name'
...
class SaltLakeCity100mGridGeoName(GeoNameTemplate, Base):
    __table_args__ = {'schema': 'preprocess2'}
    __tablename__ = 'salt_lake_city_100m_grid_geo_name'
